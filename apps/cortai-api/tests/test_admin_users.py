...
class FakeSession:
    def __init__(self) -> None:
        self.users: list[User] = [
            self.make_user(org_id=ORG_A, email="admin@hotel-a.test"),
            self.make_user(org_id=ORG_B, email="admin@hotel-b.test"),
        ]
...
def test_create_user_uses_principal_org(client: TestClient, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    assert response.json()["email"] == "new.user@hotel-a.test"
